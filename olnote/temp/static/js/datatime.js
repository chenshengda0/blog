...
function calendar() {
    ...
    var now = new Date();
    document.write('<font class="today" style="color:red;display:block;text-align:center">' + today.getFullYear() + "&nbsp;" + monthNames[now.getMonth()] + now.getDate() + "日&nbsp;" + dayNames[now.getDay()] + "</FONT>");
